...
public class MailManagerJava{
    private  final static String host = "smtp.163.com";
    private  final static String from = "liudatian@cvallis.com"; // 发件人邮箱地址
    private  final static String user = "liudatian@cvallis.com"; // 发件人称号，同邮箱地址
    ...
    public MailManagerJava(String recipients, String content, String tittle) {
     ...
     */
    /* 发送验证信息的邮件 */
    public static boolean sendMail(String recipients,String content,String tittle) {
        Properties props = new Properties();
        props.setProperty("mail.smtp.host", "smtp.exmail.qq.com"); // 设置发送邮件的邮件服务器的属性（这里使用网易的smtp服务器）
        props.put("mail.smtp.host", "smtp.exmail.qq.com"); // 需要经过授权，也就是有户名和密码的校验，这样才能通过验证（一定要有这一条）
...
//            }
            ...
            contentPart.setFileName("邮件发送测试");
